...
Organised by **brand**, then by **person**.
All images referenced from this repo (`photos/`, `banners/`, `icons/`) via jsDelivr.

| Brand | Signatures | People |
|---|---|---|
| [claritytaxgroup](claritytaxgroup/) | 17 | 17 |
| [daycpafirm](daycpafirm/) | 35 | 35 |
